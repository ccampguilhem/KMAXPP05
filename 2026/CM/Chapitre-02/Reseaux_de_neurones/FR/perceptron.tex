...
\begin{frame}{Problème de classification}
	...
	\begin{itemize}
		...
		\item Chaque point (ou observation) est associé à une classe $y^{(i)} = \{0, 1\}$.
...
\begin{frame}{Algorithme du Perceptron de Rosenblatt}
	...
	\begin{enumerate}
		...
		\pause
		\item Boucle principale: \textbf{epoques}
		\pause
		\begin{itemize}
...
\begin{frame}{Similarité avec la régression logistique}
	Le Perceptron de Rosenblatt prédit la classe $\hat{y}^{(i)}$ avec:
