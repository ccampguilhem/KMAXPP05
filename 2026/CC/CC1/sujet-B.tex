...
\begin{document}
	...
	\begin{itemize}[nosep]
		\item Notes de cours et TD autorisés.
...
%	\noindent \begin{minipage}{\textwidth}
	...
	\begin{question}
		...
		\begin{tasks}(1)
			...
			\task Vaut 1 si la corrélation linéaire entre les prédictions $\hat{y}$ et les valeurs observées $y$ est égale à 1. 
...
%	\noindent \begin{minipage}{\textwidth}
	...
	\begin{question}
		...
		\begin{tasks}(1)
			...
			\task Un risque vrai qui devient faible par rapport au risque empirique.
		\end{tasks}
	\end{question}
%	\end{minipage}
