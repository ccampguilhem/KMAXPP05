...
\begin{center}
{\bf\large \'Epreuve du 25 avril 2024} \\
...
\noindent
On rappelle que la fonction arc-tangente notée $\arctan$ est la fonction réciproque de la fonction tangente sur $]-\frac{\pi}{2},\frac{\pi}{2}[$. Pour $t\in\BBr$, on définit la fonction $\sigma$ par
$\sigma(t)=\frac{1}{2}+\frac{\arctan(t)}{\pi}$. 
On considère le classifieur binaire par régression arc-tangente $\hat{y} : \BBr \rightarrow \{0,1\}$, de paramètres $\beta = 0.5$ et $\alpha = -0.5$, défini par
